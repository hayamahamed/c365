---
title: Working with Containers (Podman)
sidebar:
  order: 4
---
...
- Ensure you have a system as stated in [setup](../setup) .
...
<Aside type="note" title="The container ID or the hex hash">
...
Next up, we will be seeing how to make a Capsule using Podman that works as if its the host with the tightest integration possible without degrading security measures.
