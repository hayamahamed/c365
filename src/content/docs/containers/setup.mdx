...
<Aside type="danger" title="Worth knowing">Do not run multiple atomic OSTree based OS without careful setup.</Aside>
...
<Aside type="note" title="General Info">
    ...
    <Aside type="tip" title="Encountering Unknown Terminologies">
        When encountering unknown terminologies, read the footnotes and the [glossaries](glossary) before proceeding.
    </Aside>
</Aside>
